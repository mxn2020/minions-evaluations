...
/**
 * @minions-evaluations/cli — CLI for Minions evaluations
 *
...
import { customTypes } from '@minions-evaluations/sdk';
...
program.name('evaluations').description('Benchmarks, test cases, and prompt scoring for continuous agent improvement').version('0.1.0');

program.command('info').description('Show project info').action(() => {
    console.log(chalk.bold('Minions evaluations'));
    console.log(chalk.dim('Benchmarks, test cases, and prompt scoring for continuous agent improvement'));
    console.log('');
    console.log(`  SDK:    ${chalk.cyan('@minions-evaluations/sdk')}`);
    console.log(`  CLI:    ${chalk.cyan('@minions-evaluations/cli')}`);
    console.log(`  Python: ${chalk.cyan('minions_evaluations')}`);
