# Contributing to Minions Evaluations

Thank you for your interest in contributing to Minions Evaluations!

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/minions-evaluations.git`
