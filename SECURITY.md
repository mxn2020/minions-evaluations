...
- `@minions-evaluations/sdk` (npm package)
- `minions-evaluations` (PyPI package)
- `@minions-evaluations/cli` (npm package)
- The minions-evaluations web playground
- The minions-evaluations documentation site
